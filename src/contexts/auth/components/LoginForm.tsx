  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 w-full">
        ...
        <div className="<dyad-write path="src/contexts/auth/components/LoginForm.tsx" description="Reescrevendo por completo o LoginForm.tsx para garantir integridade e estilização escura/verde esmeralda">
"use client";
